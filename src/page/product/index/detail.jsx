 ...
 * @Last Modified time: 2019-06-28 16:22:39
 */
      ...
      <div className="product-save-wrapper">
        ...
        <Form {...formItemLayout} onSubmit={e => this.handleSubmit(e)}>
          ...
          <FormItem label="所属分类">
            ...
            })(<CategorySelector disabled categoryId={categoryId} parentCategoryId={parentCategoryId}/>)}
          </FormItem>
          <FormItem label="商品价格">
            {getFieldDecorator("price", {
              rules: [{required: true, message: "请输入商品价格！"}],
            })(<HNumber disabled min={0} placeholder="价格" type="number" tips="元"/>)}
          </FormItem>
          <FormItem label="商品库存">
            {getFieldDecorator("stock", {
              rules: [{required: true, message: "请输入商品库存！"}],
            })(<HNumber disabled min={0} placeholder="库存" type="number" tips="件"/>)}
          </FormItem>
